import{_ as s,o as n,c as a,O as l}from"./chunks/framework.46ddca34.js";const f=JSON.parse('{"title":"函数参数传值","description":"","frontmatter":{},"headers":[],"relativePath":"A.前端知识整理/JS基础/函数参数传递.md","filePath":"A.前端知识整理/JS基础/函数参数传递.md","lastUpdated":1683553278000}'),e={name:"A.前端知识整理/JS基础/函数参数传递.md"},p=l(`<blockquote class="success"><h1>函数参数传值</h1></blockquote><blockquote class="danger"><h5>基本类型</h5></blockquote><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki one-dark-pro"><code><span class="line"><span style="color:#abb2bf;">const a = 1</span></span>
