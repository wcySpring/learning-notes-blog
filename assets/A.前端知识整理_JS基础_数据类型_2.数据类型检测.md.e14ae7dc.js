import{_ as s,o as n,c as a,O as l}from"./chunks/framework.46ddca34.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"A.前端知识整理/JS基础/数据类型/2.数据类型检测.md","filePath":"A.前端知识整理/JS基础/数据类型/2.数据类型检测.md","lastUpdated":1683611825000}'),p={name:"A.前端知识整理/JS基础/数据类型/2.数据类型检测.md"},e=l(`<p>[TOC]</p><blockquote class="info"><h2>判断类型</h2></blockquote><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki one-dark-pro"><code><span class="line"><span style="color:#abb2bf;">1.判断类型常用方法&#39;typeof&#39;、&#39;instanceof&#39;、&#39;Object.prototype.toString&#39;、&#39;constructor&#39;</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br></div></div><blockquote class="info"><h2>使用typeof 区分数据类型</h2></blockquote><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki one-dark-pro"><code><span class="line"><span style="color:#abb2bf;">1.&#39;typeof&#39; 是一个操作符，不是方法因此使用的时候可以加括号，也可以省略</span></span>
