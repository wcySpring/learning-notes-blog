import{d as x,h as E,a5 as A,l as h,p as R,U as j,a6 as B,a7 as C,u as T,o as I,A as N,B as O,b as c,z as g,t as z,a2 as H,a4 as Y,K as k,a8 as U,k as q,a9 as G,aa as K,ab as W,ac as Z,ad as J,ae as Q,af as nn,ag as en,ah as on,ai as tn,aj as an,ak as rn,al as sn}from"./chunks/framework.ab95ac3d.js";import{t as P}from"./chunks/theme.b737c5fc.js";import{d as _,r as vn}from"./chunks/relativeTime.e5086761.js";const hn={"<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;","&":"&amp;"};let ln=0;var cn=n=>n.replace(/[<>"&]/g,e=>hn[e]||e),pn=n=>n+ln++;const p={},mn=n=>{const{name:e,paths:t=[],d:i,polygons:o=[],points:s}=n;i&&t.push({d:i}),s&&o.push({points:s}),p[e]=Object.assign({},n,{paths:t,polygons:o}),p[e].minX||(p[e].minX=0),p[e].minY||(p[e].minY=0)},fn=(...n)=>{for(const e of n)mn(e)},un=x({name:"OhVueIcon",props:{name:{type:String,validator:n=>!n||n in p||(console.warn(`Invalid prop: prop "name" is referring to an unregistered icon "${n}".
