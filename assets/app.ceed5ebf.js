import{d as x,h as E,a4 as A,l as h,p as R,U as j,a5 as B,a6 as C,u as T,o as I,A as N,B as O,b as c,z as g,t as z,a2 as H,a3 as Y,K as k,a7 as U,k as q,a8 as G,a9 as K,aa as W,ab as Z,ac as J,ad as Q,ae as nn,af as en,ag as on,ah as tn,ai as an,aj as rn,ak as sn}from"./chunks/framework.46ddca34.js";import{t as P}from"./chunks/theme.9964768a.js";import{d as _,r as vn}from"./chunks/relativeTime.e5086761.js";const hn={"<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;","&":"&amp;"};let ln=0;var cn=n=>n.replace(/[<>"&]/g,e=>hn[e]||e),pn=n=>n+ln++;const p={},mn=n=>{const{name:e,paths:t=[],d:i,polygons:o=[],points:s}=n;i&&t.push({d:i}),s&&o.push({points:s}),p[e]=Object.assign({},n,{paths:t,polygons:o}),p[e].minX||(p[e].minX=0),p[e].minY||(p[e].minY=0)},fn=(...n)=>{for(const e of n)mn(e)},un=x({name:"OhVueIcon",props:{name:{type:String,validator:n=>!n||n in p||(console.warn(`Invalid prop: prop "name" is referring to an unregistered icon "${n}".
