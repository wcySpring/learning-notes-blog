import{d as H,h as x,a2 as C,l,p as V,U as $,a3 as A,a4 as f,K as u,a5 as R,u as P,k as T,a6 as E,a7 as I,a8 as O,a9 as j,aa as D,ab as N,ac as _,ad as B,ae as U,af as q,ag as G,ah as K,ai as W}from"./chunks/framework.e7315872.js";import{t as Z}from"./chunks/theme.e8c8d2c7.js";const J={"<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;","&":"&amp;"};let Q=0;var n1=n=>n.replace(/[<>"&]/g,e=>J[e]||e),e1=n=>n+Q++;const c={},o1=n=>{const{name:e,paths:t=[],d:a,polygons:o=[],points:h}=n;a&&t.push({d:a}),h&&o.push({points:h}),c[e]=Object.assign({},n,{paths:t,polygons:o}),c[e].minX||(c[e].minX=0),c[e].minY||(c[e].minY=0)},t1=(...n)=>{for(const e of n)o1(e)},a1=H({name:"OhVueIcon",props:{name:{type:String,validator:n=>!n||n in c||(console.warn(`Invalid prop: prop "name" is referring to an unregistered icon "${n}".
